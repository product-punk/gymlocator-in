...
function extendMaterial(
  ...
  if ('roughness' in defaults) (uniforms.roughness as { value: number }).value = (defaults as THREE.MeshStandardMaterial).roughness
  if ('metalness' in defaults) (uniforms.metalness as { value: number }).value = (defaults as THREE.MeshStandardMaterial).metalness
...
const MergedPlanes = forwardRef<THREE.Mesh, PlaneNoiseProps>(({ material, width, count, height }, ref) => {
